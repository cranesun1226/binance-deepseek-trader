...
class DeepSeekTraderTests(unittest.TestCase):
    ...
    def test_structured_call_sends_deepseek_payload_and_parses_decision(self):
        ...
        self.assertEqual(
            ...
            "Analyze with a balanced market consensus view that reasonable traders could broadly agree with to anticipate future price action and judge whether a LONG or SHORT position offers a higher expected value. "

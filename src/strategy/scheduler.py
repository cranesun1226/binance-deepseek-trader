        ...
        sections: list[tuple[str, Sequence[str], bool]] = [
            (
                ...
                [
                    ...
                    self._format_html_line("Trend Score", self._format_float(selected.get("trend_score"), 4)),
                    self._format_html_line("R Squared", self._format_float(selected.get("r_squared"), 4)),
                    self._format_html_line(
                        "Direction Consistency",
                        self._format_float(selected.get("directional_consistency"), 4),
                    ),
                    self._format_html_line("Net Return", self._format_float(selected.get("net_return_pct"), 2) + "%"),
                    self._format_html_line("Recent Min Low", self._format_usdt(selected.get("recent_kline_min_low"))),
                    self._format_html_line("Recent Max High", self._format_usdt(selected.get("recent_kline_max_high"))),
                ],
                True,
            ),
            (

...
_SYSTEM_PROMPT = (
    ...
    "Analyze with a trend-following market consensus view that reasonable momentum traders could broadly agree with to anticipate future price action and judge whether a LONG or SHORT position offers a higher expected value. "
